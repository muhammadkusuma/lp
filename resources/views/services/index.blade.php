...
@section('content')
    ...
    <div class="bg-blue-50 border border-blue-200 text-blue-900 px-4 py-3 mb-4 text-sm">
        <h4 class="font-bold mb-1">ℹ️ Daftar Layanan</h4>
        <p>Halaman ini menampilkan daftar layanan (Services) yang ditawarkan kepada client. Layanan ini akan digunakan saat pembuatan Project.</p>
    </div>
    ...
    <div class="flex items-center justify-between mb-4">
        ...
        <a href="{{ route('services.create') }}" class="bg-green-700 text-white px-3 py-1 win-border hover:bg-green-600">
            ➕ Tambah Service
        </a>
    </div>
