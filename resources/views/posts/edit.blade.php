...
@section('content')
    <div class="max-w-4xl mx-auto">
        <div class="bg-yellow-50 p-2 border-b border-yellow-300 mb-4 flex justify-between items-center win-border">
            <h2 class="font-bold text-lg text-yellow-900">✏️ Edit Artikel</h2>
                ...
                <div class="md:col-span-2 space-y-4">
                    ...
                    <div>
                        ...
                        <textarea name="content" rows="15"
                            class="w-full border-2 border-gray-400 p-2 text-sm focus:border-blue-600 outline-none shadow-inner font-mono">{{ old('content', $post->content) }}</textarea>
                        @error('content')
                            <span class="text-red-600 text-xs">{{ $message }}</span>
                        @enderror
                    </div>
